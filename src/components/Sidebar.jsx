  ...
  const friendItems = [
    {
      name: "Bagas Multiple",
      status: "Friend",
      avatar: "https://via.placeholder.com/40/FF5733/FFFFFF?text=BM",
    },
    {
      name: "Sir Dandy",
      status: "Online",
      avatar: "https://via.placeholder.com/40/33AFFF/FFFFFF?text=SD",
    },
    {
      name: "Jhon Tosan",
      status: "Offline",
      avatar: "https://via.placeholder.com/40/8A2BE2/FFFFFF?text=JT",
    },
  ];
  return (
